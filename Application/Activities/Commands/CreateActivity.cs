...
public class CreateActivity
{
    ...
    // Remember that we cannot call the UserAccessor but just the interface because there is no reference from the Application layer to the Interface layer that implememnts the interface.
