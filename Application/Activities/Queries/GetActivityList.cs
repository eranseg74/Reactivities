...
public class GetActivityList
{
    ...
    public class Handler(AppDbContext context/*, ILogger<GetActivityList> logger*/) : IRequestHandler<Query, Result<List<Activity>>>
    {
        ...
        public async Task<Result<List<Activity>>> Handle(Query request, CancellationToken cancellationToken)
        {
            ...
            if (result == null)
            {
                return Result<List<Activity>>.Failure("Failed to get activities", 400);
            }
